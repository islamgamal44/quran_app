...
Uri qurannAppUrl = Uri.parse("https://www.facebook.com/eslam.gamal365.25");
...
readBookMark() async {
  ...
  try {
    ...
    bookmarkedSura = prefs.getInt("ayah")!;
